...
gaze_npc_local_pos_security = []
gaze_npc_local_pos_passenger = []
gaze_npc_local_pos_robot = []
gaze_npc_local_pos_total = []
...
def get_capsule_data():
    ...
    global gaze_npc_local_pos_passenger
    global gaze_npc_local_pos_robot
    global gaze_npc_local_pos_total

    files = get_all_file_paths(get_local_gaze_path())
    test_mode = False
    if test_mode:
        test_frame_1 = [0, 0, 0, 0, 0, 0.8, 0]
        gaze_npc_local_pos_security.append(test_frame_1)
        gaze_npc_local_pos_passenger.append(test_frame_1)
        gaze_npc_local_pos_robot.append(test_frame_1)
        test_frame_2 = [0, 0, 0, 0.5, 0, 0, 0]
        gaze_npc_local_pos_security.append(test_frame_2)
        gaze_npc_local_pos_passenger.append(test_frame_2)
        gaze_npc_local_pos_robot.append(test_frame_2)
    ...
    for file in files:
        ...
        if subject_name in group_security:
            gaze_npc_local_pos_security = gaze_npc_local_pos_security + get_data(file)
    ...
    for file in files:
        ...
        if subject_name in group_passenger:
            gaze_npc_local_pos_passenger = gaze_npc_local_pos_passenger + get_data(file)
            gaze_npc_local_pos_total = gaze_npc_local_pos_total + get_data(file)
...
def draw_cloud():
    ...
    GROUPS = [
        (gaze_npc_local_pos_security, 'Security Group', 'blue'),
        (gaze_npc_local_pos_passenger, 'Passenger Group', 'green'),
        (gaze_npc_local_pos_robot, 'Robot Group', 'red')
        (gaze_npc_local_pos_total, 'Total Group', 'orange')
    ]
