...
sub_folder_path = "Static_DBSCAN_OnLeader"
...
def execute_dbscan(data_container, name):
    ...
    plt.ylabel('Y Position', rotation=270, va='center', ha='right', fontsize=40)
    ...
    if len(valid_points) > 1:
        ...
        plt.contourf(xx, yy, f, levels=15, cmap='gist_earth', vmin=0, vmax=0.7)
