...
def plot_topology(data, title, ax, vmin, vmax):
    ...
    ax.text(
        -8.4, 17.5, f"Top 2% Concentration Index: {concentration_index:.3f}",
        fontsize=10, color='black', bbox=dict(boxstyle="round,pad=0.2", facecolor="white", edgecolor="black")
    )
    ax.text(
...
if __name__ == "__main__":
    ...
    fig, axes = plt.subplots(nrows=1, ncols=3, figsize=(15, 5), gridspec_kw={'wspace': 0.215})
