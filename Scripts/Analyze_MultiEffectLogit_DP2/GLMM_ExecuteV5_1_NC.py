...
for i, row in fixed_effects.iterrows():
    plt.hlines(y=row['Variable'], xmin=row['CI_lower'], xmax=row['CI_upper'],
               colors='gray', alpha=0.6, linewidth=2.5)

plt.scatter(fixed_effects['Estimate'], fixed_effects['Variable'],
           c=colors, s=150, edgecolor='black', linewidth=1.5, zorder=3)
