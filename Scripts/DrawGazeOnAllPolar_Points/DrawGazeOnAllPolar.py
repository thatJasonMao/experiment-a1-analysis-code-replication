...
def plot_scatter(data, title, ax):
    ...
    ax.scatter(x, y, s=10, edgecolor='blue', facecolor='blue')
    ax.set_title(title)
    ax.set_xlabel('X')
    ax.set_ylabel('Y')
...
def draw_single_level_by_group():
    ...
    plot_scatter(local_pos_security, "Level:" + target_level + ' (Group Security)', axes[0, 0])

    plot_scatter(local_pos_passenger, "Level:" + target_level + ' (Group Passenger)', axes[0, 1])

    plot_scatter(local_pos_robot, "Level:" + target_level + ' (Group Robot)', axes[1, 0])

    plot_scatter(local_pos_total, "Level:" + target_level + ' (Group Total)', axes[1, 1])
