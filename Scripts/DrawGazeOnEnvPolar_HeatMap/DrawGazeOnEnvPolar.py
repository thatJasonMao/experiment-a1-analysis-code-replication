...
def draw_single_level_by_group():
    ...
    im1 = plot_scatter(local_pos_security, "Gaze on Env  Level:" + target_level + ' Group:Security', axes[0], 0, vmax)

    im2 = plot_scatter(local_pos_passenger, "Gaze on Env  Level:" + target_level + ' Group:Passenger', axes[1], 0, vmax)

    im3 = plot_scatter(local_pos_robot, "Gaze on Env  Level:" + target_level + ' Group:Robot', axes[2], 0, vmax)
