...
def get_gaze_distance(path):
    global total_distance, total_frames
    frame_distance = []
    ...
    total_distance += sum(frame_distance)
    total_frames += len(frame_distance)
...
def output():
    ...
    avg_value = total_distance / total_frames if total_frames > 0 else 0
    print("平均注视点距离: ", str(avg_value))
